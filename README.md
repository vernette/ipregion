...
# Enable debug mode, save output to a file and upload it to https://bashupload.com for you to download
./ipregion.sh --debug
```
...
Examples:
  ...
  ipregion.sh -d                    # Enable debug and save full trace to file and upload it to bashupload.com
```
